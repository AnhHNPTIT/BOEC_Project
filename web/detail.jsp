...
<html>
    ...
    <body>
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v7.0&appId=250508542921044&autoLogAppEvents=1" nonce="5HWYjOof"></script>
                        ...
                        <div class="col-sm-9 padding-right">
                            ...
                            <div class="col-sm-7">
                                <div class="product-information"><!--/product-information-->
                                    ...
                                    <p><b>Số lượng: </b><%=sp.getSo_luong()%></p>
                        ...
                        <div class="category-tab shop-details-tab"><!--category-tab-->
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade active in" id="reviews" >
                                    <div class="col-sm-12">
                                        <div class="fb-comments" data-href="detail.jsp?msp=<%=sp.getMa_san_pham()%>" data-numposts="5" data-width="800px"></div>
                                    </div>
                                </div>
