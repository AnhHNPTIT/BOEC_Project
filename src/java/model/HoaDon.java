...
public class HoaDon {
    ...
    private String phuong_thuc_giao_hang;
    ...
    public HoaDon(String ma_hoa_don, TaiKhoan tai_khoan, String dia_chi_giao_hang, String phuong_thuc_giao_hang, Timestamp ngay_mua_hang, Timestamp ngay_giao_hang, String tinh_trang_don_hang) {
        this.ma_hoa_don = ma_hoa_don;
        this.tai_khoan = tai_khoan;
        this.dia_chi_giao_hang = dia_chi_giao_hang;
        this.phuong_thuc_giao_hang = phuong_thuc_giao_hang;
    ...
    public String getPhuong_thuc_giao_hang() {
        return phuong_thuc_giao_hang;
    }

    public void setPhuong_thuc_giao_hang(String phuong_thuc_giao_hang) {
        this.phuong_thuc_giao_hang = phuong_thuc_giao_hang;
    }
