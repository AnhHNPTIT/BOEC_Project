...
public class HoaDon {
    ...
    public HoaDon(String ma_hoa_don, TaiKhoan tai_khoan, String dia_chi_giao_hang, String phuong_thuc_giao_hang, Timestamp ngay_mua_hang, int tinh_trang_don_hang) {
